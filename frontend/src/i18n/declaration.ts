...
export enum I18nKey {
  ...
  SETTINGS$NAV_AGENTS = "SETTINGS$NAV_AGENTS",
  SETTINGS$AGENTS_TAB_TITLE = "SETTINGS$AGENTS_TAB_TITLE",
  SETTINGS$AGENTS_TAB_DESCRIPTION = "SETTINGS$AGENTS_TAB_DESCRIPTION",
